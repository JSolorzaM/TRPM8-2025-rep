...
if __name__ == "__main__":
    ...
    if len(occ_cols) < 2:
        print("⚠️ Warning: insufficient occupancy columns detected. Proceeding with limited width scaling.")
    ...
    if df_func.empty:
        print("⚠️ No residue pairs fall within the functional ranges provided. Check your ranges.")
    else:
